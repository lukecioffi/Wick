...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("whistle"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, sound_get("firework"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, 139);
