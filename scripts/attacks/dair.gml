...
set_window_value(AT_DAIR, 3, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_DAIR, 1, HG_WINDOW_CREATION_FRAME, 16);
set_hitbox_value(AT_DAIR, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_X, 2);
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_Y, 6);
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 22);
...
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_SPRITE, sprite_get("burnerblank"));
...
set_hitbox_value(AT_DAIR, 2, HG_WINDOW_CREATION_FRAME, 16);
set_hitbox_value(AT_DAIR, 2, HG_LIFETIME, 20);
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_X, -46);
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_Y, -36);
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 96);
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 96);
...
set_hitbox_value(AT_DAIR, 2, HG_PROJECTILE_SPRITE, sprite_get("uair_proj"));
set_hitbox_value(AT_DAIR, 2, HG_PROJECTILE_MASK, sprite_get("uair_proj"));
set_hitbox_value(AT_DAIR, 2, HG_PROJECTILE_ANIM_SPEED, .3);
